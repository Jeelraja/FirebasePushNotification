...
public class AppSharedPref {
    ...
    public static String editUserNameKey = "editUserName";
    public static String editUserProPicKey = "editUserProPic";
    ...
    private AppSharedPref(Context context) {
        mContext = context;
        mSharedPreferences = context.getSharedPreferences("firebaseNotificationPref", Context.MODE_PRIVATE);
